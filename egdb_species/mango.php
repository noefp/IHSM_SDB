<a href="https://mangobase.org/jbrowse/" class="btn btn-info sps-btn" role="button" target="_blank">Genome Browser</a>
<a href="https://mangobase.org/easy_gdb/tools/blast/blast_input.php" class="btn btn-info sps-btn" role="button" target="_blank">BLAST</a>
<a href="https://mangobase.org/easy_gdb/tools/expression/expression_input.php" class="btn btn-info sps-btn" role="button" target="_blank">Expression Atlas</a>
<a href="https://mangobase.org/easy_gdb/tools/fasta_download.php" class="btn btn-info sps-btn" role="button" target="_blank">Sequence Extraction</a>
...
<div class="row" style="width:900px;margin-left:0px">
  ...
  <div class="col" style="padding:0px">
    <div class="card">
      <div class="card-body">
        <a href="/downloads/Mangifera%20indica/PDFs/descriptors_mango.pdf"><i class='far fa-file-pdf' style='font-size:30px;color:red'></i> Descriptors for mango </a>
      </div>
    </div>
  </div>
  <div class="col" style="padding:0px">
    <div class="card">
      <div class="card-body">
        <a href="/downloads/Mangifera%20indica/PDFs/Guia_descriptiva_cultivares_mango.pdf"><i class='far fa-file-pdf' style='font-size:30px;color:red'></i> Guía descriptiva de cultivares del mango </a>
      </div>
    </div>
  </div>
</div>
...
<div class="row" style="width:900px;margin-left:0px">
  ...
  <div class="col" style="padding:0px">
    <div class="card">
      <div class="card-body">
        <a href="/downloads/Mangifera%20indica/PDFs/mango_guia_plagas.pdf"><i class='far fa-file-pdf' style='font-size:30px;color:red'></i> Guia de gestion integrada de plagas de mango</a>
      </div>
    </div>
  </div>
  <div class="col" style="padding:0px">
    <div class="card">
      <div class="card-body">
        <a href="/downloads/Mangifera%20indica/PDFs/Plagas_y_enfermedades_mango.pdf"><i class='far fa-file-pdf' style='font-size:30px;color:red'></i> Plagas y enfermedades del mango</a>
      </div>
    </div>
  </div>
...
<div class="row" style="width:900px;margin-left:0px">
  ...
  <div class="col" style="padding:0px">
    <div class="card">
      <div class="card-body">
        <a href="/downloads/Mangifera%20indica/PDFs/Training_&_pruning_mango.pdf"><i class='far fa-file-pdf' style='font-size:30px;color:red'></i> Training and Pruning Mango tree </a>
      </div>
    </div>
  </div>
...
<ul>
  <li>cv. Tommy Atkins, by the <a href="https://bmcplantbiol.biomedcentral.com/articles/10.1186/s12870-021-02858-1" target="_blank">Mango Genome Consortium 2021</a>.</li>
  <li>cv. Alphonso, by <a href=https://genomebiology.biomedcentral.com/articles/10.1186/s13059-020-01959-8>Wang et al., 2020</a>. Available at the <a href="https://www.ncbi.nlm.nih.gov/data-hub/genome/GCF_011075055.1/" target="_blank">NCBI</a>.</li>
...
<?php include_once("mango_classification_table.php");?>
